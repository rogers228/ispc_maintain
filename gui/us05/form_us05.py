...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.email.setGeometry(QtCore.QRect(110, 20, 331, 24))
        font = QtGui.QFont()
        font.setFamily("新細明體")
        ...
        self.label_2.setGeometry(QtCore.QRect(20, 20, 71, 24))
        font = QtGui.QFont()
        font.setFamily("新細明體")
        font.setPointSize(12)
...
"}")
        ...
        self.password.setGeometry(QtCore.QRect(110, 50, 331, 24))
        font = QtGui.QFont()
        font.setFamily("新細明體")
        font.setPointSize(12)
...
"}")
        ...
        self.label_5.setGeometry(QtCore.QRect(20, 80, 81, 24))
        font = QtGui.QFont()
        font.setFamily("新細明體")
        font.setPointSize(12)
...
"}")
        ...
        self.full_name.setGeometry(QtCore.QRect(110, 80, 331, 24))
        font = QtGui.QFont()
        font.setFamily("新細明體")
        font.setPointSize(12)
        ...
        self.login.setGeometry(QtCore.QRect(170, 160, 141, 31))
        font = QtGui.QFont()
        font.setFamily("新細明體")
        font.setPointSize(12)
